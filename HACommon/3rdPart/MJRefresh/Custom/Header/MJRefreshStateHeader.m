...
- (UILabel *)stateLabel
{
    ...
    [_stateLabel setFont:kNormalFont(15)];
    [_stateLabel setTextColor:[UIColor colorWithRed:0x66/255.0 green:0x66/255.0 blue:0x66/255.0 alpha:1.0]];
...
- (UILabel *)lastUpdatedTimeLabel
{
    ...
    [_lastUpdatedTimeLabel setFont:kNormalFont(13)];
    [_lastUpdatedTimeLabel setTextColor:[UIColor colorWithRed:0x99/255.0 green:0x99/255.0 blue:0x99/255.0 alpha:1.0]];
...
- (void)setLastUpdatedTimeKey:(NSString *)lastUpdatedTimeKey
{
    ...
    if (lastUpdatedTime) {
        ...
        self.lastUpdatedTimeLabel.text = @"last updated: none";
    }
}
